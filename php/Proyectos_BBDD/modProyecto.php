                                    ...
                                    <form action="controlador.php" method="POST" class="user">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                name="project-name" value="<?php echo $proyecto["nombre"]?>" required>
                                        </div>
                                        <!-- Initial date -->
                                        <div class="form-group">
                                            <label for="" class="form-label">Fecha inicial:</label>
                                            <input type="date" class="form-control"
                                                name="initial-date" value="<?php echo $proyecto["fecha_inicio"]?>" required>
                                        </div>
                                        <!-- Finishing date -->
                                        <div class="form-group">
                                        <label for="" class="form-label">Fecha fin prevista:</label>
                                            <input type="date" class="form-control"
                                            name="finishig-date"  value="<?php echo $proyecto["fecha_fin"]?>" required>
                                        </div>
                                        <!-- Days -->
                                        <div class="form-group">
                                        <label for="" class="form-label">Días transcurridos:</label>
                                            <input type="number" class="form-control"
                                            name="days-passed"  value="<?php echo $proyecto["dias_transcurridos"]?>" required>
                                        </div>
                                        <!-- Completed % -->
                                        <div class="form-group">
                                            <label for="" class="form-label">Porcentaje completado:</label>
                                            <input type="number" class="form-control"
                                                name="percentage"  value="<?php echo $proyecto["porcentaje_completado"]?>" min="0" max="100" placeholder="0-100" required>
                                        </div>
                                        <!-- Importance -->
                                        <div class="form-group">
                                        <label for="" class="form-label">Importancia:</label>
                                            <input type="number" class="form-control" placeholder="1-5"
                                            name="importance"  value="<?php echo $proyecto["importancia"]?>" min="1" max="5" required>
                                        </div>
                                        <input type="hidden" name="id" value="<?php echo $proyecto['id']?>"> <!-- Get id -->
                                        <div class="d-flex justify-content-between">
                                            <input type="submit" class="btn btn-primary btn-user btn-block" value="Modificar proyecto" name="modificarProyecto">
