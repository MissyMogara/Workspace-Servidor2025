                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="controlador.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-text small p-3">La contraseña ha de tener 8 caracteres y al menos una minuscula.</div>
                                        </div>
                                        ...
                                        <?php 
                                        if(isset($_GET["error"])){
                                            if($_GET["error"] == "Already-Registered"){
                                                echo '<div class="form-text text-danger">Usuario ya registrado.</div>';    
                                            }
                                            if($_GET["error"] == "notFound"){
                                                echo '<div class="form-text text-danger">Error login.</div>';
                                            }
                                        }
                                        ?>
                                    </form>
